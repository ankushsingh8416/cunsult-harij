        ...
        <div className="border-2 border-[#1A9BA1] rounded-2xl overflow-hidden bg-white">
            ...
            <div className="flex items-center gap-3 px-5 py-3.5 bg-[#F7F7F7] border-t border-[#EEEEEE]">
                ...
                <div className="flex-1">
                    ...
                    <span className="inline-block mt-1 text-[11px] font-semibold px-2 py-[2px] rounded-full tag-orange blur-tag select-none">
                        Science
                    </span>
                </div>
                <Lock size={15} color="#AAAAAA" className="shrink-0" />
                <button className="text-xs text-[#AAAAAA] border border-[#DDDDDD] rounded-full px-3 py-1 bg-white cursor-not-allowed whitespace-nowrap">
                    Start
                </button>
            </div>
            ...
            <div className="flex items-center gap-3 px-5 py-3.5 bg-white border-t border-[#EEEEEE]">
                ...
                <button className="text-xs text-[#888888] border border-[#DDDDDD] rounded-full px-3 py-1 bg-white whitespace-nowrap">
                    Completed
                </button>
            </div>
